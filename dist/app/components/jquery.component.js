...
var JQueryComponent = (function () {
    function JQueryComponent(el) {
        this.el = el;
        this.title = 'jQuery Examples';
    }
    JQueryComponent.prototype.ngAfterViewInit = function () {
        jQuery(this.el.nativeElement).find('button#btnDynamicBind').on('click', function () {
            alert('Control Id: ' + jQuery(this).attr('id'));
        });
    };
    JQueryComponent.prototype.clickMe = function (value) {
        alert(value);
    };
